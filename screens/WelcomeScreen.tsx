...
export default class WelcomeScreen extends Component<{}, state> {
    ...
    userSignUp = (email: string, password: string, confirmPassword: string) => {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.profileContainer}>
                    ...
                    <Text style={{ color: '#ff8a65' }}> A Trading app for a Trading method </Text>
                </View>
